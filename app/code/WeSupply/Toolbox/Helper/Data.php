...
class Data extends AbstractHelper
{
     ...
     * Platform name
     */
    public const WESUPPLY_PLATFORM_TYPE = 'embedded';

    /**
     * WeSupply tracking cms page url
     */
    public const WESUPPLY_TRACKING_INFO_URI = 'wesupply/track/shipment';

    /**
     * Array of carrier codes that are excluded from being sent to wesupply validation
     */
    public const EXCLUDED_CARRIERS = [
        'flatrate',
        'tablerate',
        'freeshipping',
    ];

    public const FILTER_ORDERS_BY_MAP = [
