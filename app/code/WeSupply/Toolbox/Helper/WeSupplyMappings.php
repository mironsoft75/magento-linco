...
class WeSupplyMappings extends AbstractHelper
{
     ...
     */
    public const WESUPPLY_ORDER_PROCESSING = 1;
    public const WESUPPLY_ORDER_RECEIVED = 2;
    public const WESUPPLY_ORDER_COMPLETE = 3;
    public const WESUPPLY_ORDER_PENDING_SHIPPING = 4;
    public const WESUPPLY_ORDER_CANCELLED = 5;
    public const WESUPPLY_ORDER_ONHOLD = 6;
    public const WESUPPLY_ORDER_PARTIALLY_COMPLETE = 7;
    public const WESUPPLY_ORDER_PAYMENT_FAILURE = 8;
    public const WESUPPLY_ORDER_RETURN = 9;

    public const WESUPPLY_ITEM_CANCELLED = 1;
    public const WESUPPLY_ITEM_RETURN = 2;
    public const WESUPPLY_ITEM_SHIPPED = 3;
    public const WESUPPLY_ITEM_PROCESSING = 4;
    public const WESUPPLY_ITEM_PICKUP = 15;

    public const WESUPPLY_ITEM_PROCESSING_LABEL = 'Processing';


    public const INSTORE_PICKUP_LABEL = 'In Store Pickup';

    public const MAPPED_CARRIER_CODES = [
        'ups'     => 'UPS',
        'usps'    => 'USPS',
        'fedex'   => 'FedEx',
        'dhl'     => 'DHL',
    ...
    public const ORDER_FINAL_STATUS_IDS = [
