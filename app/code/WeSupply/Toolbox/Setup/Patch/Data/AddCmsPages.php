...
class AddCmsPages implements DataPatchInterface, PatchVersionInterface
{
     ...
     */
    public const WESUPPLY_TRACKING_ID = 'wesupply-tracking-info';

    /**
     * WeSupply store locator page url
     */
    public const WESUPPLY_STORE_LOCATOR_ID = 'wesupply-store-locator';

    /**
     * WeSupply store-details page url
     */
    public const WESUPPLY_STORE_DETAILS_ID = 'wesupply-store-details';
