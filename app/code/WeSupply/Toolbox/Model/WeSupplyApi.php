...
class WeSupplyApi implements WeSupplyApiInterface
{
    ...
    public const AUTH_ORDER_PATH = 'authLinks';
    public const SUBSCRIBE_PATH = 'phone/enrol';
    public const UNSUBSCRIBE_PATH = 'phone/unsubscribe';
    public const ESTIMATIONS_PATH = 'estimations';
    public const SHIPPING_QUOTES_PATH = 'shippingQuotes';
    public const CHECK_SERVICE_PATH = 'permissions';

    /**
     * delivery estimation uri for a single product (product view page)
     */
    public const DELIVERY_ESTIMATE_URI = 'shippingEstimate';

    /**
     * delivery estimations uri for multiple products (cart and checkout pages)
     */
    public const DELIVERY_ESTIMATES_URI = 'shippingEstimates';

    /**
     * dynamic constants used for build api endpoints
     */
    public const ALLOWED_COUNTRIES_URI = 'getShippingAllowedCountries';

    public const ADMIN_KEY_URI = 'getAdminKey';

    public const WS_ORDER_FILEDS_MAP =
        [
    ...
    private function getToken()
    {
        ...
        if (is_array($generatedToken)) {
            $generatedTime = $generatedToken['created_at'] ?? '';
