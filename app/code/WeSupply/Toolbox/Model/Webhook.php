...
class Webhook extends DataObject
{
    ...
    public const ORDER_PREFIX = 'mage_';

    public const RETURN_PARAMS = [
        'guid',
        'client-name',
        'reference',
    ];
    public const RETURN_PARAMS_MAP = [
        'guid' => 'wesupply_api/integration/access_key',
        'client-name' => 'wesupply_api/integration/wesupply_subdomain',
        'reference' => null,
    ];

    public const PICKUP_PARAMS = [
        'guid',
        'client_name',
        'order_id',
        'pickup_store_id',
    ...
    public const PICKUP_PARAMS_MAP = [
        'guid' => 'wesupply_api/integration/access_key',
    ...
    public const COUPON_CODE_PARAMS = [
        'guid',
        'client_name',
        'order_id',
        'customer_id',
    ...
    public const COUPON_CODE_PARAMS_MAP = [
        'guid' => 'wesupply_api/integration/access_key',
        'client_name' => 'wesupply_api/integration/wesupply_subdomain',
        'order_id' => null,
        'customer_id' => null,
