...
{
    public const XML_PATH_CONFIG_ENABLED_MODULE        = "quickview/general/enabled";
    public const XML_PATH_CONFIG_INSERTION             = "quickview/general/insertion";
    public const XML_PATH_CONFIG_LOADING_IMAGE         = "quickview/general/loading_image";
    public const XML_PATH_CONFIG_QUICKVIEW_INIT        = "quickview/general/quickview_init";
