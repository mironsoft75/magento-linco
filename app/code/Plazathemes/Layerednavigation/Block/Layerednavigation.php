...
{
    public const XML_PATH_CONFIG_ENABLED_MODULE        = "ajaxlayerednavigation/general/enabled";
    public const XML_PATH_CONFIG_ENABLED_PRICE_SLIDER  = "ajaxlayerednavigation/general/price_slider";
    public const XML_PATH_CONFIG_LOADING_IMAGE         = "ajaxlayerednavigation/general/loading_image";
