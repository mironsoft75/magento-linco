...
class Configuration {
    public const RENDER_PRODUCT_LIST_SELECT_IN_HIDDEN_DIV = 'mana_core/debug/product_list_select';
    public const ENABLE_PROFILER = 'mana_core/debug/profiler';
    public const LOG_LAYOUT_XML = 'mana_core/log/layout_xml';
    public const LOG_PAGE_QUERIES = 'mana_core/log/page_queries';
    public const INCLUDE_QUERY_STACK_TRACE = 'mana_core/log/query_stack_trace';
    public const INCLUDE_CSS = 'mana_core/compatibility/include_css';
    public const CATEGORY_PAGE_URL_EXTENSION = 'catalog/seo/category_url_suffix';

    public const CMS_HOME_PAGE = 'web/default/cms_home_page';
    public const HOME_PAGE_TYPE = 'web/default/front';
    ...
    public function getCategoryPageUrlExtension() {
        return $this->scopeConfig->getValue(
            static::CATEGORY_PAGE_URL_EXTENSION,
