<?php
namespace Lyracons\Slideshow\Helper;
...
class Image extends AbstractHelper
{
    ...
    \Magento\Framework\App\Helper\Context $context, \Magento\Framework\Image\Factory $imageFactory, \Magento\Framework\Filesystem $filesystem, \Magento\Store\Model\StoreManagerInterface $storeManager
    ...
    {
        //if (!$this->_processor) {
        $filename = $this->_baseFile ? $this->_mediaDirectory->getAbsolutePath('lyracons/slideshow' . $this->_baseFile) : null;
    ...
    public function fileExists($baseFile)
    {
        $filename = $this->_mediaDirectory->getAbsolutePath('lyracons/slideshow' . $baseFile);
    ...
    public function resize($width, $height = null)
    {
        if ($this->_baseFile) {
            ...
            $this->_height = $height;
            if (!$this->isCached()) {
                $path = 'lyracons/slideshow/cache/' . $width . 'x' . $height;
