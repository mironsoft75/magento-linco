...
namespace Lyracons\Slideshow\Model\ResourceModel;

/**
 * Lyracons slideshow mysql resource
 */
class Slideshow extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    \Magento\Framework\Model\ResourceModel\Db\Context $context, \Magento\Framework\Stdlib\DateTime $dateTime, $connectionName = null
    )
    {
    ...
    {
        $this->_init('lyracons_slideshow', 'slideshow_id');
    }
     ...
     * @param string $field
     * @param mixed $value
     * @param \Lyracons\Slideshow\Model\Page $object
