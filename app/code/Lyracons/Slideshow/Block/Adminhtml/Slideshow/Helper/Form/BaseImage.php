...
class BaseImage extends \Magento\Framework\Data\Form\Element\AbstractElement
{
     ...
     */
    const ELEMENT_OUTPUT_TEMPLATE = 'Lyracons_Slideshow::slideshow/edit/form/renderer/content.phtml';
    ...
    /**
     * @var \Lyracons\Slideshow\Helper\Data
     */
     ...
     * @param \Lyracons\Slideshow\Helper\Data $sliderHelperData
     * @param \Magento\Framework\File\Size $fileConfig
     * @param \Magento\Framework\View\LayoutInterface $layout
     * @param array $data
     */
    public function __construct(
    \Magento\Framework\Data\Form\Element\Factory $factoryElement, \Magento\Framework\Data\Form\Element\CollectionFactory $factoryCollection, \Magento\Framework\Escaper $escaper, \Magento\Framework\View\Asset\Repository $assetRepo, \Magento\Backend\Model\UrlFactory $backendUrlFactory, \Lyracons\Slideshow\Helper\Data $sliderHelperData, \Magento\Framework\File\Size $fileConfig, \Magento\Framework\View\LayoutInterface $layout, array $data = []
    )
    {
    ...
    public function createElementHtmlOutputBlock()
    {
        ...
        $block = $this->layout->createBlock(
            'Magento\Framework\View\Element\Template', 'slideshow.details.form.base.image.element'
        );
