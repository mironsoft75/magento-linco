<?php
namespace Lyracons\Slideshow\Ui\Component\Listing\Column;

use Magento\Framework\View\Element\UiComponent\ContextInterface;
use Magento\Framework\View\Element\UiComponentFactory;
use Magento\Ui\Component\Listing\Columns\Column;
use Lyracons\Slideshow\Block\Adminhtml\Slideshow\Grid\Renderer\Action\UrlBuilder;
...
class SlideshowActions extends Column
{
    ...
    ContextInterface $context, UiComponentFactory $uiComponentFactory, UrlBuilder $actionUrlBuilder, UrlInterface $urlBuilder, array $components = [], array $data = [], $editUrl = self::SLIDESHOW_URL_PATH_EDIT
    )
    {
