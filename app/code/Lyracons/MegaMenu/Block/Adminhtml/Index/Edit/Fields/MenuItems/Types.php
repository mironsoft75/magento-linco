<?php
namespace Lyracons\MegaMenu\Block\Adminhtml\Index\Edit\Fields\MenuItems;
...
class Types extends \Magento\Backend\Block\Template
{
            ...
            [
                ...
                'content' => [
                    ...
                    ['title' => __('Icon Item use'), 'name' => 'icon_type', 'type' => 'dropdown',
                        ...
                        'action' => 'lcmenu.switchIconChooser(this);',
                    ],
            ...
            [
                ...
                'content' => [
                    ...
                    ['title' => __('<span style="margin-top: 12.5px;display: inline-block;">Background for content</span>'), 'type' => 'label',
                        'value' => 'For example <a class="full-view-img" data-href="' . $this->getImageUrl('menu/background.jpg') . '" onclick="lcmenu.viewfull(this)" href="javascript:void(0)"><img src="' . $this->getImageUrl('menu/background_small.jpg') . '" /></a> <a class="full-view-link" onclick="lcmenu.viewfull(this)" data-href="' . $this->getImageUrl('menu/background.jpg') . '" href="javascript:void(0)">' . __('Click to view example') . '</a>'],
            ...
            [
                ...
                'content' => [
                    ...
                    ['title' => __('Display Type'), 'name' => 'display_type', 'type' => 'dropdown',
                        ...
                        'description' => '<p>For example:</p><p><a class="full-view-link" style="text-decoration: none;" onclick="lcmenu.viewfull(this)" data-href="' . $this->getImageUrl('menu/category_list_type_1.jpg') . '" href="javascript:void(0)"><i class="fa fa-hand-pointer-o"></i> ' . __('Show categories list as a drop down menu of item title') . '</a></p><p><a style="text-decoration: none;" class="full-view-link" onclick="lcmenu.viewfull(this)" data-href="' . $this->getImageUrl('menu/category_list_type_2.jpg') . '" href="javascript:void(0)"><i class="fa fa-hand-pointer-o"></i> ' . __('Show categories list just below item title') . '</a></p>',
                    ],
                    ['title' => __('Menu Icon Item'), 'type' => 'label', 'value' => 'For example <i class="fa fa-diamond"></i> Diamond'],
    ...
    {
        return $this->_assetRepo->getUrl('Lyracons_MegaMenu/images/' . $path);
    }
}
