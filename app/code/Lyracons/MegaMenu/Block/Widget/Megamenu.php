<?php
namespace Lyracons\MegaMenu\Block\Widget;

use Magento\Framework\View\Element\Template;
use Lyracons\MegaMenu\Block\Widget\CategoriesTree;
use Lyracons\MegaMenu\Model\MegamenuFactory as MegamenuFactory;
...
class Megamenu extends Template implements \Magento\Widget\Block\BlockInterface
{
    ...
    public function getBackgroundStyle($content)
    {
        switch ($content->bg_position) {
            case 'left_top':
                return "left:{$content->bg_position_x}px; top:{$content->bg_position_y}px";
                break;
            case 'left_bottom':
                return "left:{$content->bg_position_x}px; bottom:{$content->bg_position_y}px";
                break;
            case 'right_top':
                return "right:{$content->bg_position_x}px; top:{$content->bg_position_y}px";
                break;
            case 'right_bottom':
            default:
                return "right:{$content->bg_position_x}px; bottom:{$content->bg_position_y}px";
                break;
        }
    }
    ...
    public function getItemCSSClass($item)
    {
        ...
        switch ($item->item_type) {
            ...
            case 'text':
                ...
                break;
            case 'row':
                $class[] = 'row no-dropdown';
                break;
            case 'col':
                $class[] = 'col need-unwrap';
                break;
            case 'tab_container':
                break;
            case 'tab_item':
    ...
    {
        return $this->getLayout()->createBlock('Lyracons\MegaMenu\Block\Widget\CategoriesTree');
    }
    ...
    {
        return [\Lyracons\MegaMenu\Model\Megamenu::CACHE_TAG . '_' . $this->getMenu()];
    }
}
