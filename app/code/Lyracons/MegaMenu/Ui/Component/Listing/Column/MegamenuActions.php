<?php
namespace Lyracons\MegaMenu\Ui\Component\Listing\Column;
...
class MegamenuActions extends Column
{
    ...
    /** Url path */
    public const MENU_URL_PATH_EDIT = 'megamenu/index/edit';
    public const MENU_URL_PATH_DELETE = 'megamenu/index/delete';
