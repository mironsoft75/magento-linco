<?php
namespace Lyracons\MegaMenu\Controller\Index;
...
class Export extends \Magento\Framework\App\Action\Action
{
    ...
    public function __construct(
        ...
        \Lyracons\MegaMenu\Model\MegamenuFactory $menuFactory
    )
    {
    ...
    {
        return $this->_authorization->isAllowed('Lyracons_MegaMenu::save');
    }
    ...
    public function execute()
    {
        ...
        $file = $this->fixtureManager->getFixture('Lyracons_MegaMenu::fixtures/lyracons_megamenu.csv');
