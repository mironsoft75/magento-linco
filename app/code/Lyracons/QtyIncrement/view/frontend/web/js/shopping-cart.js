    ...
    $.widget('mage.shoppingCart', {
        ...
        _create: function () {
            ...
            $(".plus-cart").click(function (event) {
                ...
                let inputQtyElement = $(`#cart-${itemId}-qty`);
                let oldValue = parseFloat(inputQtyElement.val());
                let increment = parseFloat($(this).attr('data-cart-item-increment'));
            ...
            $(".sub-cart").click(function (event) {
                event.preventDefault();
                let itemId = $(this).attr('data-cart-item-id');
                let qtyElement = $(`#cart-${itemId}-qty`);
                let oldValue = parseFloat(qtyElement.val());
                let defaultValue = parseFloat($(this).attr('data-cart-item-increment'));
