...
class Api extends \Magento\Framework\Model\AbstractModel
{
    ...
    public const TYPE_TRIGGER_LINK_CLICK = 'linkClick';
    public const TYPE_TRIGGER_PAGEVIEW = 'pageview';
    public const TYPE_TRIGGER_DOMREADY = 'domReady';
    public const TYPE_TAG_UA = 'ua';
     ...
     * Variable names
     */
    public const VARIABLE_UA_TRACKING = 'WP - UA Tracking ID';
    public const VARIABLE_EVENTLABEL = 'WP - Event Label';
    public const VARIABLE_EVENTVALUE = 'WP - Event Value';

    /**
     * Trigger names
     */
    public const TRIGGER_PRODUCT_CLICK = 'WP - Product Click';
    public const TRIGGER_GTM_DOM = 'WP - gtm.dom';
    public const TRIGGER_ADD_TO_CART = 'WP - Add To Cart';
    public const TRIGGER_REMOVE_FROM_CART = 'WP - Remove From Cart';
    public const TRIGGER_ALL_PAGES = 'WP - All Pages';
    public const TRIGGER_EVENT_IMPRESSION = 'WP - Event Impression';
    public const TRIGGER_PROMOTION_CLICK = 'WP - Promotion Click';
    public const TRIGGER_CHECKOUT_OPTION = 'WP - Checkout Option';
    public const TRIGGER_CHECKOUT_STEPS = 'WP - Checkout Steps';
    public const TRIGGER_PROMOTION_VIEW = 'WP - Promotion View';
    public const TRIGGER_ADD_TO_WISHLIST = 'WP - Add To Wishlist';
    public const TRIGGER_ADD_TO_COMPARE = 'WP - Add To Compare';

    /**
     * Tag names
     */
    public const TAG_GOOGLE_ANALYTICS = 'WP - Google Analytics';
    public const TAG_PRODUCT_EVENT_CLICK = 'WP - Product Event - Click';
    public const TAG_PRODUCT_EVENT_ADD_TO_CART = 'WP - Product Event - Add to Cart';
    public const TAG_PRODUCT_EVENT_REMOVE_FROM_CART = 'WP - Product Event - Remove from Cart';
    public const TAG_PRODUCT_EVENT_PRODUCT_IMPRESSIONS = 'WP - Product Event - Product Impressions';
    public const TAG_CHECKOUT_STEP_OPTION = 'WP - Checkout Step Option';
    public const TAG_CHECKOUT_STEP = 'WP - Checkout Step';
    public const TAG_PROMOTION_IMPRESSION = 'WP - Promotion Impression';
    public const TAG_PROMOTION_CLICK = 'WP - Promotion Click';
    public const TAG_PRODUCT_EVENT_ADD_TO_WISHLIST = 'WP - Product Event - Add to Wishlist';
    public const TAG_PRODUCT_EVENT_ADD_TO_COMPARE = 'WP - Product Event - Add to Compare';
