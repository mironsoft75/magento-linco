...
class Api extends \Magento\Framework\Model\AbstractModel
{
     ...
     * Item types
     */
    public const TYPE_VARIABLE_DATALAYER = 'v';
    public const TYPE_VARIABLE_CONSTANT = 'c';
    public const TYPE_TRIGGER_CUSTOM_EVENT = 'customEvent';
    public const TYPE_TRIGGER_PAGEVIEW = 'pageview';
    public const TYPE_TAG_GAAWC = 'gaawc';
    public const TYPE_TAG_GAAWE = 'gaawe';
    public const TYPE_TAG_AWCT = 'awct';
    public const TYPE_TAG_SP = 'sp';

    /**
     * Variable names
     */
    public const VARIABLE_MEASUREMENT_ID = 'WP - MEASUREMENT ID';
    public const VARIABLE_CUSTOMER_ID = 'WP - GA4 - user_id';
    public const VARIABLE_CUSTOMER_GROUP = 'WP - GA4 - customerGroup';
    public const VARIABLE_PAGE_TYPE = 'WP - GA4 - Page Type';
    public const VARIABLE_ECOMMERCE_ITEMS = 'WP - GA4 - ecommerce.items';
    public const VARIABLE_ECOMMERCE_ITEM_LIST_ID = 'WP - GA4 - ecommerce.item_list_id';
    public const VARIABLE_ECOMMERCE_ITEM_LIST_NAME = 'WP - GA4 - ecommerce.item_list_name';
    public const VARIABLE_TRANSACTION_ID = 'WP - GA4 - transaction_id';
    public const VARIABLE_COUPON = 'WP - GA4 - coupon';
    public const VARIABLE_TAX = 'WP - GA4 - tax';
    public const VARIABLE_SHIPPING = 'WP - GA4 - shipping';
    public const VARIABLE_CURRENCY = 'WP - GA4 - currency';
    public const VARIABLE_ORDER_VALUE = 'WP - GA4 - Order Value';
    public const VARIABLE_CUSTOMER_TOTAL_ORDER_COUNT = 'WP - GA4 - Customer - total_order_count';
    public const VARIABLE_CUSTOMER_TOTAL_LIFETIME_VALUE = 'WP - GA4 - Customer - total_lifetime_value';
    public const VARIABLE_PURCHASE_VALUE = 'WP - GA4 - Purchase Value';
    public const VARIABLE_PAYMENT_TYPE = 'WP - GA4 - Payment Type';
    public const VARIABLE_SHIPPING_TIER = 'WP - GA4 - Shipping Tier';
    public const VARIABLE_SEARCH_TERM = 'WP - GA4 - Search Term';
    public const VARIABLE_LOGIN = 'WP - GA4 - Login';
    public const VARIABLE_SIGNUP = 'WP - GA4 - Signup';
    public const VARIABLE_PROMOTION_CREATIVE_NAME = 'WP - GA4 - Promotion Creative Name';
    public const VARIABLE_PROMOTION_CREATIVE_SLOT = 'WP - GA4 - Promotion Creative Slot';
    public const VARIABLE_PROMOTION_ID = 'WP - GA4 - Promotion Id';
    public const VARIABLE_PROMOTION_NAME = 'WP - GA4 - Promotion Promotion Name';

    /**
     * Trigger names
     */
    public const TRIGGER_SELECT_ITEM = 'WP - GA4 - select_item';
    public const TRIGGER_GTM_DOM = 'WP - GA4 - gtm.dom';
    public const TRIGGER_ADD_TO_CART = 'WP - GA4 - add_to_cart';
    public const TRIGGER_REMOVE_FROM_CART = 'WP - GA4 - remove_from_cart';
    public const TRIGGER_VIEW_CART = 'WP - GA4 - view_cart';
    public const TRIGGER_VIEW_ITEM = 'WP - GA4 - view_item';
    public const TRIGGER_VIEW_ITEM_LIST = 'WP - GA4 - view_item_list';
    public const TRIGGER_SELECT_PROMOTION = 'WP - GA4 - select_promotion';
    public const TRIGGER_VIEW_PROMOTION = 'WP - GA4 - view_promotion';
    public const TRIGGER_BEGIN_CHECKOUT = 'WP - GA4 - begin_checkout';
    public const TRIGGER_PURCHASE = 'WP - GA4 - purchase';
    public const TRIGGER_ADD_SHIPPING_INFO = 'WP - GA4 - add_shipping_info';
    public const TRIGGER_ADD_PAYMENT_INFO = 'WP - GA4 - add_payment_info';
    public const TRIGGER_ADD_TO_WISHLIST = 'WP - GA4 - add_to_wishlist';
    public const TRIGGER_SEARCH = 'WP - GA4 - search';
    public const TRIGGER_LOGIN = 'WP - GA4 - login';
    public const TRIGGER_SIGNUP = 'WP - GA4 - sign_up';

    public const TRIGGER_ALL_PAGES_ID = '2147479553';

    /**
     * Tag names
     */
    public const TAG_MEASUREMENT_ID = 'WP - GA4';
    public const TAG_ITEM_LIST_VIEWS_IMPRESSIONS = 'WP - GA4 - item list views/impressions';
    public const TAG_PRODUCT_ITEM_LIST_CLICKS = 'WP - GA4 - product/item list clicks';
    public const TAG_ITEM_ADD_TO_CART = 'WP - GA4 - add to cart';
    public const TAG_ITEM_REMOVE_FROM_CART = 'WP - GA4 - remove from cart';
    public const TAG_VIEW_CART = 'WP - GA4 - view cart';
    public const TAG_ITEM_VIEWS_IMPRESSIONS = 'WP - GA4 - item views/impressions';
    public const TAG_VIEW_PROMOTION = 'WP - GA4 - View Promotion';
    public const TAG_CLICK_PROMOTION = 'WP - GA4 - Click Promotion';
    public const TAG_BEGIN_CHECKOUT = 'WP - GA4 - Begin Checkout';
    public const TAG_PURCHASE = 'WP - GA4 - Purchase';
    public const TAG_ADD_SHIPPING_INFO = 'WP - GA4 - Add Shipping Info';
    public const TAG_ADD_PAYMENT_INFO = 'WP - GA4 - Add Payment Info';
    public const TAG_ADD_TO_WISHLIST = 'WP - GA4 - Add To Wishlist';
    public const TAG_SEARCH = 'WP - GA4 - Search';
    public const TAG_LOGIN = 'WP - GA4 - Login';
    public const TAG_SIGNUP = 'WP - GA4 - Signup';
