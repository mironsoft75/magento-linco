...
class License extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    {
        $moduleName = $userFriendlyNames[$licenseOptions['module_name']] ?? $licenseOptions['module_name'];
        $msgPrefix = '';
        if ($usePrefix) {
        ...
        $licenseModuleName = $userFriendlyNames[$licenseDetails[1]] ?? $licenseDetails[1];
